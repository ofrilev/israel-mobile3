    ...
    >  
      <View className="flex-1 justify-center items-center p-8">
        ...
        <View className="mb-12 items-center">
          ...
          <Text className="text-3xl font-bold text-gray-800 mb-2">Israel Geography</Text>
        ...
        >
          <Text className="text-white text-2xl font-bold text-center">🎮 Start Game</Text>
        </Pressable>
        ...
        <View className="flex-row gap-4">
          ...
          >
            <Text className="text-white text-lg font-semibold">🗺️ Map Demo</Text>
          </Pressable>
          ...
          >
            <Text className="text-white text-lg font-semibold">🧪 Style Test</Text>
          </Pressable>
        </View>
